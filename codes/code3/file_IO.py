# -*- coding: utf-8 -*-
"""
Created on Thu Feb 20 17:06:21 2020
...
file_path = '/Users/zhangdi/ACT4311/codes/code3/data/GOT.txt'
#open file with write mode and manage the file by variable wf
with open(file_path,'wt',encoding='utf8') as wf:
    #save the string to the file
    wf.write(jon)


#open file and manage the file by variable rf
with open(file_path,'rt',encoding='utf8') as rf:
    # read the whole content to jon_new in one batch
    jon_new = rf.read()
print(jon_new)
print("'琼恩' appears", jon_new.count('琼恩'),'times.')
