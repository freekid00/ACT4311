...
with open('./data/stock_announcement.csv','w',newline='',encoding='utf-8-sig') as wf:
    ...
    for stock in stocks:#process stock one by one
        ...
        if response.status_code == 200:
            ...
            for div in title_divs:#get and store announcement title one by one  
                ...
                writer.writerow([stock,date_str,title] ) 
        else: 
            print("Faisled to crawl", stock)
            
with open('./data/stock_announcement.csv','r',newline='',encoding='utf-8-sig') as rf:
