...
with open(file_path,'r',encoding='utf8') as rf:
    ...
    jon_new = rf.read()
print(jon_new)
print(jon_new.count('琼恩'))

print("\n=======Read in lines in 1 batch==========")
#open file and manage the file by variable rf
count1=0
with open(file_path,'r',encoding='utf8') as rf:
    # read the whole content in a list of line and process it line by line
    for line in rf.readlines():
        print(line,end='')
        count1 += line.count('琼恩')
print('count1=',count1)
...
#open file and manage the file by variable rf
with open(file_path,'r',encoding='utf8') as rf:
    # read the whole content  line by line
    for line in rf:
        count2 += line.count('琼恩')
        print(line,end='')
print('count2=',count2)
